...
(isNotBusyNode node8)
(isNodesConnected node8 node4)
(isBelow node8 node4)
(isNodesConnected node8 node7)
(isOnRight node8 node7)
(isNotBusyNode node9)
(isNodesConnected node9 node5)
(isBelow node9 node5)
...
(isNodesConnected node24 node26)
...
(isNodesConnected node25 node27)
...
(isNodesConnected node26 node24)
...
(isNotBoxOnGoal box4)
(isBusyNode node27)
(isNodesConnected node27 node25)
