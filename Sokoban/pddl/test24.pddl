...
(isNodesConnected node10 node3)
(isBelow node10 node3)
(isNotBusyNode node11)
(isNodesConnected node11 node5)
...
(isNodesConnected node12 node17)
...
(isNodesConnected node17 node12)
(isBelow node17 node12)
(isNodesConnected node17 node24)
...
(isNodesConnected node22 node29)
...
(isGoalNode node24)
(isNodesConnected node24 node17)
(isBelow node24 node17)
(isNodesConnected node24 node30)
...
(isNodesConnected node25 node31)
...
(isNodesConnected node26 node32)
...
(isNodesConnected node29 node22)
...
(isNodesConnected node32 node26)
