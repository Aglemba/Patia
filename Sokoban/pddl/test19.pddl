...
(isNotBusyNode node5)
(isNodesConnected node5 node12)
(isAbove node5 node12)
(isNodesConnected node5 node6)
(isOnLeft node5 node6)
(isNotBusyNode node6)
(isNodesConnected node6 node13)
(isAbove node6 node13)
...
(isBelow node9 node3)
(isNodesConnected node9 node17)
(isAbove node9 node17)
...
(isNodesConnected node10 node18)
(isAbove node10 node18)
...
(isGoalNode node11)
(isBusyNode node11)
(isNodesConnected node11 node19)
...
(isNodesConnected node12 node5)
(isBelow node12 node5)
(isNodesConnected node12 node20)
...
(isNodesConnected node13 node6)
(isBelow node13 node6)
(isNodesConnected node13 node21)
...
(isNodesConnected node14 node22)
...
(isNotBoxOnGoal box2)
(isBusyNode node17)
(isNodesConnected node17 node9)
(isBelow node17 node9)
...
(isNodesConnected node18 node10)
(isBelow node18 node10)
...
(isGoalNode node19)
(isBusyNode node19)
(isNodesConnected node19 node11)
...
(isAgentOnNode agent1 node20)
(isNotBusyNode node20)
(isNodesConnected node20 node12)
...
(isNodesConnected node21 node13)
...
(isNodesConnected node22 node14)
